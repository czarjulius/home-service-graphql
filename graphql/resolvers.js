...
const getAllServices = async (args, req, {}) => {
...
const createService = async ({ serviceInput }, req) => {
  // if (!req.isAuth) {
...
const createVendor = async ({ vendorInput }, req) => {
  // if (!req.isAuth) {
  //   const error = new Error("Not authenticated!");
  //   error.code = 401;
  //   throw error;
...
const createOrder = async ({ orderInput }, req) => {
  // if (!req.isAuth) {
  //   const error = new Error("Not authenticated!");
  //   error.code = 401;
  //   throw error;
...
export default {
  Query: {
    services: combineResolvers(AuthMiddleWare.isAuthenticated, getAllServices),
  },
  Mutation: {
    login,
  },
